        ...
        <div class="card-body">
            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        <input name="title" type="text" class="form-control" id="inputTitle" value="{{ $product->title }}">
                    </div>
                    @error('title')
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        <textarea name="detail_description" class="form-control" id="inputDetailDescription" rows="5">{{ $product->detail_description }}</textarea>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        <textarea name="purchase_conditions" class="form-control" id="inputPurchaseConditions" rows="3">{{ $product->purchase_conditions }}</textarea>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        <textarea name="sales_contact" class="form-control" id="inputSalesContact" rows="3">{{ $product->sales_contact }}</textarea>
                    </div>
                    @error('sales_contact')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
